...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-16">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 via-background to-violet-50" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            <ScrollReveal>
              <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/70 backdrop-blur border border-indigo-200 text-primary text-sm font-medium mb-6 shadow-sm">
            ...
            <ScrollReveal delay={0.3}>
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="/register">
                  <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 border-0">
          ...
          <ScrollReveal direction="left" delay={0.2}>
            <div className="relative mx-auto max-w-md">
              {/* Glow behind mockup */}
              <div className="absolute -inset-6 bg-gradient-to-br from-indigo-400/30 via-violet-400/20 to-fuchsia-400/30 rounded-[2.5rem] blur-2xl" />

              {/* Main Preview Card */}
              <div className="relative bg-white/90 backdrop-blur rounded-3xl shadow-2xl shadow-indigo-500/10 p-4 border border-border">
                ...
                <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-indigo-100 via-violet-100 to-fuchsia-100 flex items-center justify-center overflow-hidden relative">
                  <div className="text-center p-8">
                    <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center mb-5 shadow-lg shadow-indigo-500/30">
              ...
              <div className="absolute -bottom-5 -left-4 bg-white rounded-2xl shadow-xl border border-border p-3.5 animate-float" style={{ animationDelay: "1.2s" }}>
                <div className="flex items-center gap-2.5">
                  <span className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-indigo-50">
              ...
              <div className="absolute top-1/2 -right-6 bg-white rounded-2xl shadow-xl border border-border p-3.5 animate-float" style={{ animationDelay: "2.4s" }}>
                <div className="flex items-center gap-2.5">
                  <span className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-violet-50">
